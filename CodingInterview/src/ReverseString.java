...
public class ReverseString {
	...
	public static void method1(String input) {
		...
		System.out.println("Char Array method runtime: " + (double)(totalTime/1000000.0) + " seconds");
		System.out.println();
	}
	...
	public static void method2(String input) {
		...
		System.out.println("StringBuilder method runtime: " + (double)(totalTime/1000000.0) + " seconds");
		System.out.println();
	...
	public static void method3(String input) {
		...
		long totalTime = System.nanoTime() - startTime;
		System.out.println("Char Array method runtime: " + (double)(totalTime/1000000.0) + " nanoseconds");
	}
